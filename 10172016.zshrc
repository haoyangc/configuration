...
export PROD="titan-timber-1a-i-b728502d.us-east-1.amazon.com"
...
alias copy-production-heatmap-draft="date +\"%m-%d-%Y\" | xargs -I draft-{} bash -c \"aws s3 sync s3://infra-capacity-planning-development/capacity-planning/dataset/ {} --exclude '*' --include 'DRAFT-*'\""
